...
def start_adc(port, pci):
    ...
    command = "cd /home/milosz/projects/distributed-oscilloscope/software/DistributedOscilloscope/nodes/adc_lib_node/;" +\
        "source adc_venv/bin/activate;" +\
        "dist_osc_adc_node --ip_server PCBE15195 --port " +\
